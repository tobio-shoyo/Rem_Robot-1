...
remcmd = KigyoTelegramHandler(d).command
remmsg = KigyoTelegramHandler(d).message
remcallback = KigyoTelegramHandler(d).callbackquery
reminline = KigyoTelegramHandler(d).inlinequery
